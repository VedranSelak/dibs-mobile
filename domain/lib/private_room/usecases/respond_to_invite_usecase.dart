...
typedef Params = InviteRequestParams;

class RespondToInviteUseCase implements UseCase<Response, Params> {
  RespondToInviteUseCase(this.privateRoomApiRepository);
  final PrivateRoomApiRepository privateRoomApiRepository;

  @override
  Future<Response> call({required Params params}) {
    return privateRoomApiRepository.respondToInvite(params);
  }
}
